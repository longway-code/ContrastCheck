...
class TestContrastAnalyzer(unittest.TestCase):
    ...
    @patch('contrast_check.main.ColorExtractor')
    @patch('contrast_check.main.ContrastChecker')
    def test_analyze_image_no_text(self, mock_checker, mock_color, mock_ocr, mock_imread):
    ...
    @patch('contrast_check.main.ColorExtractor')
    @patch('contrast_check.main.ContrastChecker')
    def test_analyze_image_with_text(self, mock_checker, mock_color, mock_ocr, mock_imread):
        ...
        mock_ocr_instance.get_text_region_mask.return_value = np.ones((100, 100), dtype=bool)
        mock_ocr.return_value = mock_ocr_instance
        ...
        mock_color_instance.rgb_to_hex.side_effect = lambda rgb: '#{:02x}{:02x}{:02x}'.format(*rgb)
        mock_color.return_value = mock_color_instance
    ...
    def test_generate_report_json(self):
        ...
        with patch('contrast_check.main.OCRExtractor'), \
             patch('contrast_check.main.ColorExtractor'), \
             patch('contrast_check.main.ContrastChecker'):
